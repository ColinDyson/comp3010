...
public class BankServ_Threaded implements Runnable {
	...
	Hashtable<Integer, Integer> accounts;

    BankServ_Threaded(Socket csocket, Hashtable<Integer, Integer> accounts) {	// constructor called by server for each client
    ...
    public static void main(String[] args) {
		...
		// Accept a connection (can only be force quit for now)
			...
			new Thread(new BankServ_Threaded(cli, accounts)).start();	//Start a new thread for each client we accept
		}
	}
    ...
    static synchronized String create(Hashtable<Integer, Integer> accounts, int acctNumber) {
    	String status = null;
    ...
    static synchronized String retrieve(Hashtable<Integer, Integer> accounts, int acctNumber) {
    	String status = null;
    ...
    static synchronized String deposit(Hashtable<Integer, Integer> accounts, int acctNumber, int ammount) {
    	String status = null;
    ...
    static synchronized String withdraw(Hashtable<Integer, Integer> accounts, int acctNumber, int ammount) {
    	String status = null;
